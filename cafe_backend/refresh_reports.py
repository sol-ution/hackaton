...
SEED = [
    (4, 2, 3, 3, "many", "none", "two", "자리 거의 없어요", 5),
    (4, 2, 3, 4, "many", "none", "solo", "", 12),
    (4, 3, 2, 3, "many", "none", "three-four", "2층도 만석", 20),
    (4, 1, 4, 3, "normal", "none", "two", "", 100),
    (5, 1, 3, 2, "normal", "none", "solo", "", 8),
    (5, 1, 3, 3, "normal", "none", "two", "적당해요", 70),
    (6, 3, 3, 4, "many", "none", "five-plus", "대기 3팀", 4),
    (6, 3, 2, 4, "many", "none", "three-four", "", 15),
    (6, 2, 3, 4, "many", "none", "two", "", 25),
    (7, 0, 4, 3, "many", "none", "solo", "한산함", 10),
    (7, 1, 4, 3, "many", "none", "two", "", 95),
]
...
with open(REPORTS_CSV, "w", newline="", encoding="utf-8") as f:
    w = csv.writer(f)
    w.writerow(FIELDS)
    for (cid, cl, q, r, o, s, v, note, m) in SEED:
        reported = (now - timedelta(minutes=m)).isoformat()
        w.writerow([cid, cl, q, r, o, s, v, note, reported])
